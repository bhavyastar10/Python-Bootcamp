...
# passenger = int(input("Enter you age : "))
# if passenger < 18 :
#     print("Ticket fare 2")
# elif passenger > 59 :
#     print("Ticket fare 5")
...
# Loop :
# for i in iterable : range(4, 10, 2)
# enumerate(lst) : add numbering with each elements
...
# Try:
# except <errorname>:
# except :    for any unexpected error not listed above
